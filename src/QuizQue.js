        ...
        <div>
          ...
          <section>
            ...
            <div className="option_list">
              {questions ? (
                questions[currentQ].options.map((ans, index) => {
                  return (
                    <button
                      className="option"
                      onClick={(e) => checkScore(e, ans)}
                      key={index}
                    >
                      {ans}
                    </button>
          ...
          {questions ? (
            <footer>
              <div className="total_que">
                {questions ? questions[currentQ].numb : <Skeleton />} out{" "}
                {questions ? questions.length : <Skeleton />}
              </div>
              <button className="next_btn" onClick={nextQue}>
                Next Que
              </button>
            </footer>
          ) : (
